...
int MDCommon_WetBulbTempDef () {
    ...
    switch (optID) {
        case MDinput:
            ...
            break;
        case MDcalculate:
            if (((_MDInSpecificHumidityID = MDCommon_HumiditySpecificDef()) == CMfailed) ||
                ...
                ((_MDInAirPressureID      = MFVarGetID (MDVarCommon_AirPressure, "pa", MFInput, MFState, MFBoundary)) == CMfailed) ||
